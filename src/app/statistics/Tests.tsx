                ...
                {TESTS.map((test,index)=>(
                 <tr key={index} className='border-b'>
                        ...
                        <div className={`border rounded-2xl p-5 w-48 absolute right-56 bg-white  ${hoveredTestIndex === index ? '' : 'hidden'}`} onMouseEnter={() => handleMouseEnter(index)} onMouseLeave={handleMouseLeave}>
                          <h1 className='border-b  pb-3'>Edit</h1>
                          <h1 className='mt-3'>Remove</h1> </div>
                          <div className='flex justify-between'>
                          <Image src='./Edit.svg' alt='edit' width={24} height={24} onMouseEnter={() => handleMouseEnter(index)} onMouseLeave={handleMouseLeave}/>
                          <Image src='./pepicons.svg' alt='edit' width={24} height={24}/>
                          </div>
                        </td>
                    </tr>
